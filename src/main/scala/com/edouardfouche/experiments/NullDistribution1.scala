...
/**
  ...
  * Look at the distribution of the tests with M=1
  */
object NullDistribution1 extends Experiment {
  override val alpha_range: Vector[Double] = Vector()
  override val M_range = Vector(1) // I am trying something here
  ...
  def run(): Unit = {
    for {
      ...
      info(s"Starting com.edouardfouche.experiments with configuration: n=$N, M: $m, nDim: 2")
