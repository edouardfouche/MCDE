...
/**
  ...
  * Look at the distribution of the tests with M=100
  */
object NullDistribution100 extends Experiment {
  override val alpha_range = Vector(0.1)
  override val M_range = Vector(100) // I am trying something here
