...
/**
  * A Scala wrapper for HiCS (Keller et al. 2012)
  * Implemented by Hoang-Vu Nguyen, from the uds package: http://eda.mmci.uni-saarland.de/prj/uds/
  */
case class HICS(calibrate:Boolean = false, var parallelize:Int = 0) extends ExternalStats {
  val id = "HiCS"
