 ...
 */
package com.edouardfouche.stats.mcde

import com.edouardfouche.index.CorrectedRankIndex
import com.edouardfouche.utils.HalfGaussian
...
case class MWPs(M: Int = 50, alpha: Double = 0.5, calibrate: Boolean = false, var parallelize: Int = 0) extends McdeStats {
